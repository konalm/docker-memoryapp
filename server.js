...
app.get('/createNewMemory', function(req, res) {
    
    res.render('createNewMemory.ejs'); 
});


app.get('/uploadProfilePic', function(req, res) {
    ...
    var sql = "SELECT ProfilePicPath FROM ProfilePics WHERE Email = '" + email + "'"; 
    ...
    conn.query(sql, function (err, result) {
        if (err) {
            ...
            var picPath = result[0].ProfilePicPath; 
